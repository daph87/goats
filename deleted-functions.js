...
// function displayVaccine(i) {
        //     let vaccine = [];
        //     let listVaccins = [];
        //     let newList;
        //     goats[i].vaccins.forEach(element => {
        //         vaccine.push(element)
        //     });

        //     for (let j = 0; j < vaccine.length; j++) {
        //         listVaccins.push(`<p><span class="boldColor">Name & Date:</span> ${vaccine[j].name} ${vaccine[j].vaccinationDate}</p>
        //            `);
        //     }

        //     newList = listVaccins.join(' ').toString();
        //     return newList;
        // }


        // function editVaccine(i) {
        //     let vaccine = [];
        //     let listVaccins = [];
        //     let newList;
        //     goats[i].vaccins.forEach(element => {
        ...
        //     for (let j = 0; j < vaccine.length; j++) {
        //         listVaccins.push(`<label>Vaccin ${j + 1} </label><input type="text" id=vaccineName${vaccine[j].id} value="${vaccine[j].name}"></br><input type="text" id=vaccineDate${vaccine[j].id} value="${vaccine[j].vaccinationDate}"></br>`);
        //     }
